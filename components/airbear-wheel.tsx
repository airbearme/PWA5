...
// ⚡ Bolt: Memoized AirbearWheel to prevent unnecessary re-renders.
// This is a purely presentational component, so re-rendering is only needed
// when its props change. `memo` provides that performance optimization.
