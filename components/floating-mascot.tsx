...
export default function FloatingMascot() {
  ...
  // Replaced useState with framer-motion's useMotionValue and useSpring.
  // This prevents the component from re-rendering on every mouse movement,
  // offloading the animation logic from React's render cycle for a much
  // smoother and more performant effect.
  ...
  const springConfig = { damping: 15, stiffness: 100, mass: 0.1 };
