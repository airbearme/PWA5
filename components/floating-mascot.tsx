...
export default function FloatingMascot() {
  ...
  // Performance optimization: useTransform avoids re-renders on mouse move
  const followX = useTransform(mouseX, (x) => x * 0.01);
  const followY = useTransform(mouseY, (y) => y * 0.01);
  ...
  return (
    ...
    >
      <Link href="/" className="transition-all duration-500 opacity-100 translate-y-0">
