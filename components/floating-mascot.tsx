...
export default function FloatingMascot() {
  ...
  // Replaced useState with framer-motion's useMotionValue to prevent re-renders on every mouse move.
  // This offloads the animation from React's render cycle to a more performant, dedicated animation engine.
  // useSpring is used to create a smoother, more natural "follow" effect.
  ...
  // Transform mouse position for a subtle parallax effect
  const followX = useTransform(springX, (v) => v * 0.01);
  const followY = useTransform(springY, (v) => v * 0.01);
