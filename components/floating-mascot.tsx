...
export default function FloatingMascot() {
  ...
  // Create a spring for a smoother follow effect, avoiding re-renders.
  const springConfig = { stiffness: 100, damping: 20, mass: 0.5 };
  const springX = useSpring(useTransform(x, (latestX) => latestX * 0.015), springConfig);
  const springY = useSpring(useTransform(y, (latestY) => latestY * 0.015), springConfig);
