        ...
        <div className="relative z-10">
          ...
          {!showInstructions ? (
            ...
            <div className="space-y-4 animate-in fade-in zoom-in-95 duration-300">
              <h3 className="text-lg font-bold text-foreground mb-2">How to Install</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 bg-white/5 p-2 rounded-lg border border-white/10">
                  ...
                  <div className="text-sm">
                    <span className="font-semibold block text-emerald-400">iOS Safari</span>
                    <span className="text-muted-foreground text-xs">Tap Share then &quot;Add to Home Screen&quot;</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 bg-white/5 p-2 rounded-lg border border-white/10">
                  ...
                  <div className="text-sm">
                    <span className="font-semibold block text-amber-400">Android Chrome</span>
                    <span className="text-muted-foreground text-xs">Tap Menu then &quot;Install App&quot;</span>
                  </div>
                </div>
              </div>
