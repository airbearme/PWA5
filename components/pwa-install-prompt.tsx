          ...
          {!showInstructions ? (
            ...
            <div className="animate-in fade-in slide-in-from-right-5 duration-300">
              <button
                ...
                className="flex items-center text-xs text-emerald-400 hover:text-emerald-300 transition-colors mb-4 group"
                aria-label="Back to installation prompt"
              >
              ...
              <div className="space-y-3">
                <div className="bg-white/5 p-3 rounded-xl border border-white/10">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-sm font-semibold text-foreground">iOS Safari</p>
                  </div>
                  <p className="text-xs text-muted-foreground ml-10">
                    Tap <span className="text-emerald-400 font-medium">Share</span> then <span className="text-emerald-400 font-medium">Add to Home Screen</span>
                  </p>
                </div>
                ...
                <div className="bg-white/5 p-3 rounded-xl border border-white/10">
                  ...
                  <p className="text-xs text-muted-foreground ml-10">
                    Tap <span className="text-blue-400 font-medium">Menu</span> then <span className="text-blue-400 font-medium">Install App</span>
                  </p>
                </div>
              </div>
