...
export const rides = pgTable("rides", {
	...
	pickupSpotId: varchar("pickup_spot_id")
		.notNull()
		.references(() => spots.id),
	dropoffSpotId: varchar("dropoff_spot_id")
		.notNull()
		.references(() => spots.id), // Renamed for consistency
...
export const airbearInventory = pgTable("airbear_inventory", {
	...
	airbearId: varchar("airbear_id")
		.notNull()
		.references(() => airbears.id),
	itemId: varchar("item_id")
		.notNull()
		.references(() => bodegaItems.id),
