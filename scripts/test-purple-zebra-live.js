...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_PWA4_URL || "https://your-project.supabase.co";
const supabaseServiceKey =
	process.env.SUPABASE_PWA4_SERVICE_ROLE_KEY || "your-service-role-key";
const supabaseAnonKey =
	process.env.NEXT_PUBLIC_SUPABASE_PWA4_ANON_KEY || "your-anon-key";

console.log("🔌 Testing Purple Zebra...");
