...
// Mock fetch for environments where it's not available or when server is not running
if (typeof fetch === 'undefined' || (typeof jest !== 'undefined' && jest.isMockFunction && !jest.isMockFunction(fetch))) {
