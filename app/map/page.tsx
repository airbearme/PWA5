  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Load spots and airbears in parallel to improve loading performance
        // This reduces TTI by parallelizing independent Supabase requests, potentially saving 100-300ms of waterfall latency.
