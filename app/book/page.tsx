...
// Utility functions extracted outside component to prevent re-creation on every render
...
export default function BookRidePage() {
  ...
  // Optimized: Load spots only once on mount
  useEffect(() => {
  ...
  // Optimized: Sync pickup spot from URL independently
  useEffect(() => {
