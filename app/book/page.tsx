...
export default function BookRidePage() {
  ...
  // ⚡ Bolt: Memoize distance and fare calculations.
  // This prevents expensive calculations on every re-render.
  // The values are only recalculated when the pickup or destination spots change.
