...
/**
 * Calculates the Haversine distance between two spots
...
/**
 * Estimates the fare based on distance
 * Moved outside component to prevent re-creation on every render
 */
...
export default function BookRidePage() {
  ...
  // Effect 1: Load all active spots once on mount
  useEffect(() => {
  ...
  // Effect 2: Synchronize pickup spot from URL search params
  // Decoupled from loadSpots to prevent redundant database fetches when URL changes
  useEffect(() => {
  ...
  const handleBookRide = async () => {
    ...
    try {
      ...
      // Using component-level distance and fare to avoid redundant calculations
