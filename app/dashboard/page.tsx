  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Load user rides and spots in parallel to improve dashboard loading speed
        // Parallelization reduces network waterfall and improves Time to Interactive (TTI).
