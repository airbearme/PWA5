      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-8">
          ...
          <div className="mb-8 animate-float">
            {/* ⚡ Bolt: Replaced standard <img> with next/image for optimized loading.
                This enables lazy loading, responsive sizing, and modern formats (like WebP),
                improving the Largest Contentful Paint (LCP) score. Added `priority`
                to preload this critical, above-the-fold image.
            */}
            <Image
