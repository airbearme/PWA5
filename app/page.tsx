      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-8">
          ...
          <div className="mb-8 animate-float">
            {
              /* ⚡ Bolt: Replaced standard <img> with next/image for automatic optimization,
                 lazy loading, and modern format delivery (e.g., WebP).
                 This improves loading performance. Using 128x128 based on w-32/h-32 classes.
              */
            }
            <Image
