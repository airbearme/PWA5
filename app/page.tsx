      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-8">
          ...
          <div className="mb-8 animate-float">
            {/* ⚡ Bolt: Optimized image loading with next/image */}
            {/* Replaced standard <img> with Next.js <Image> to enable modern formats (WebP), */}
            {/* automatic resizing, and lazy loading. Added `priority` to preload this */}
            {/* critical, above-the-fold image for a faster Largest Contentful Paint (LCP). */}
            <Image
