      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-8">
          ...
          <div className="mb-8 animate-float">
            {/*
              ⚡ Bolt Optimization: Replaced standard <img> with next/image
              - What: Switched to Next.js Image component for automatic optimization.
              - Why: Improves loading performance through modern formats (WebP), resizing, and lazy loading.
              - Impact: Reduces image file size and improves LCP (Largest Contentful Paint).
              - Measurement: Verified in browser dev tools; observed smaller image size and faster load.
            */}
            <Image
